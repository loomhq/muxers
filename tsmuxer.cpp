...
void TsMuxer::buildPmt() {
  ...
  pmt_.push_back(0xb0);  // section_syntax_indicator ('1') + '0' + reserved (2bits)  + '00'
                         // section_length (2bits)
  ...
  pmt_.push_back(0b11000001);  // reserved(2) + version_number(5) + current_next_indicator(1);
